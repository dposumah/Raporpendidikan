        ...
        try {
          ...
          const formattedData = json.map(row => {
            ...
            return {
              ...
              alamat_siswa: getVal(['Alamat_1', 'Alamat', 'Alamat Siswa']),
              dusun_siswa: getVal(['Nama Dusun_1', 'Dusun_1', 'Nama Dusun', 'Dusun Siswa', 'Dusun']),
              kelurahan_siswa: getVal(['Desa Kelurahan_1', 'Kelurahan_1', 'Desa_1', 'Desa Kelurahan', 'Kelurahan Siswa', 'Kelurahan', 'Desa']),
              kecamatan_siswa: getVal(['Kecamatan_1', 'Kecamatan_2', 'Kecamatan Tempat Tinggal', 'Kecamatan Domisili', 'Kec. Tempat Tinggal', 'Kecamatan Siswa', 'Kecamatan']),
              kabupaten_siswa: getVal(['Kabupaten_1', 'Kabupaten_2', 'Kabupaten Tempat Tinggal', 'Kabupaten Domisili', 'Kab. Tempat Tinggal', 'Kota Tempat Tinggal', 'Kabupaten Siswa', 'Kabupaten', 'Kota']),
              provinsi_siswa: getVal(['Propinsi_1', 'Provinsi_1', 'Propinsi', 'Provinsi', 'Provinsi Siswa']),
              kode_pos_siswa: getVal(['Kode Pos_1', 'Kode Pos', 'Kode Pos Siswa']),
